...
# postulate-edsger-v1-release Docker image, for a GitHub Release asset --
...
# Docker image itself).
#
# Requires `postulate-edsger-v1-release` already built
...
NAME="postulate-edsger-v1-${VERSION}-linux-x86_64"
